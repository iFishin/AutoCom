    ...
    def test_print_full_table(self):
        ...
        tp.add_row(
            [
                ...
                "FAIL",
                "device_long_name",
                "long_command_with_emoji✅",
                "this is a very long response that should be truncated or wrapped",
            ]
        )
        ...
        tp.add_row(
            [
                ...
                "dev3",
                "install",
                "error occurred during installation, please check logs for details",
            ]
        )
